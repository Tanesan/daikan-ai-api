...
X_uramen_features = scaler_h.fit_transform(X_uramen_features)

# uramen
best_uramen_params =  {'learning_rate': 0.2597526609194758, 'max_depth': 9, 'subsample': 0.9146211531173168, 'colsample_bytree': 0.8662060278161825, 'reg_alpha': 3.3518303070391205e-05, 'reg_lambda': 0.0001674967889168822, 'min_child_weight': 2}


dtrain_uramen = xgb.DMatrix(X_uramen_features, label=y_uramen)

model_uramen = xgb.train(
        best_uramen_params,
        dtrain_uramen,
        num_boost_round=300,
...
model_uramen.save_model("uramen_model.json")
joblib.dump(scaler_h, "uramen_scaler.pkl")