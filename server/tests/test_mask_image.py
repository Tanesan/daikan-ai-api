...
def test_mask_image():
    with open("tests/images/test_mask.png", "rb") as image_file:
        response = client.post(
            ...
            files={"image": ("tests/images/test_mask.png", image_file, "image/png")}
        )
    ...
    assert response_data["url"] == "https://daikan-data-devo2.s3.ap-northeast-1.amazonaws.com/test_404176_2_0_1000/mask.png"
